...
|     Address: shadowblocks.nyx:3260,1
...
Login to [iface: default, target: iqn.2026-02.nyx.shadowblocks:storage.disk1, portal: shadowblocks.nyx:3260] --login] successful.
```
...
bashroot-5.3# id
uid=1000(lenam) gid=1000(lenam) euid=0(root) groups=1000(lenam),24(cdrom),25(floppy),29(audio
s),101(netdev)
